...
wget https://raw.githubusercontent.com/faithvoid/script.cortanawireless/refs/heads/main/share_wifi_bridged.sh
mkdir /opt/CortanaWireless

# Copy service files to systemd directory
cp CortanaWireless.service CortanaWirelessRemote.service /etc/systemd/system/
cp share_wifi_bridged.sh CortanaWireless.py /opt/CortanaWireless
